...
public class Modele {
	...
	public enum PointVue {N, S, E, O, DESSUS, NE, NO, SE, SO};
	private PointVue pdv = PointVue.N;
	private Color couleurEnCours = Color.RED;//couleur par défaut
	private LinkedList listeConstruction, ordreB;
	...
	void afficherConstruction() {
		//afficher la construction en cours grace au fichier dans lequel sont référencées toutes les briques
		//contenues dans cette construction
		//appelle une sous fonction qui tri l'ordre des briques en fonction de la vue
		
		
		//lorsque l'utilisateur clique sur une construction elle devient la constructionEnCours
	}
	...
	boolean ajouterConstruction(String nomNouvelleC) {
		...
		return //true si on a ajouté la construction, false sinon
	}
